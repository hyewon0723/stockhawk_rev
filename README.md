...
The purpose of this project was to handle exceptions(user input error/network exception), added the graph of stock price histogram and created widget for home screen
